...
os.system('clear')
name = input(h+ 'Digite seu nome: ' +k)
password = input(h+ 'Digite a senha: ' +k)
...
def main():
	print(logo())
	print(b+'╔══════════════════════════════\n'+b+'║'+h+'〘 '+m+'MODOS '+h+'〙\n'+b+'╠══════════════════════════════'+b+'\n║'+m+'『'+h+'0'+m+'』'+bm+' VOLTAR\n'+b+'╠══════════════════════════════'+b+'\n║'+m+'『'+h+'1'+m+'』 '+bm+'Número único Número único\n'+b+'║'+m+'『'+h+'2'+m+'』 '+bm+'Multi número\n'+b+'║'+m+'『'+h+'3'+m+'』 '+bm+'Carregar o número do arquivo \n'+b+'║'+m+'『'+h+'4'+m+'』 '+bm+'Selecione o número do contato \n'+b+'╠══════════════════════════════')
...
def jnspam():
	global jns
	print(logo())
	print(b+'╔══════════════════════════════\n'+b+'║'+h+'〘 '+m+'SPAM '+h+'〙\n'+b+'╠══════════════════════════════'+b+'\n║'+m+'『'+h+'▣'+m+'』'+bm+' Exit\n'+b+'╠══════════════════════════════'+b+'\n║'+m+'『'+h+'1'+m+'』 '+bm+'TODOS\n'+b+'║'+m+'『'+h+'2'+m+'』 '+bm+'opção 1\n'+b+'║'+m+'『'+h+'3'+m+'』 '+bm+'opção 2\n'+b+'║'+m+'『'+h+'4'+m+'』 '+bm+'opção 3\n'+b+'║'+m+'『'+h+'5'+m+'』 '+bm+'opção 4(ilimitada)\n'+b+'║'+m+'『'+h+'6'+m+'』 '+bm+'número indonésio( +62 or 0)\n'+b+'╠══════════════════════════════')
	while True:
